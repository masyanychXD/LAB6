...
if __name__ == '__main__':
    ...
    time_res = timeit.repeat("res = [fermat_factorization(i) for i in TEST_LST];",
                  setup='import math; from python_code import is_perfect_square; from python_code import fermat_factorization; TEST_LST = [101, 9973, 104729, 101909, 609133, 1300039, 9999991, 99999959, 99999971, 3000009, 700000133]',
                  number=1, repeat=1)
    print(time_res)
